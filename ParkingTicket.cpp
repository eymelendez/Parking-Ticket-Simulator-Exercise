...
ParkingTicket::ParkingTicket(double aFine)
{
	setFine(aFine);
}

ParkingTicket::ParkingTicket(const ParkingTicket & aParkingMeter)
{
	setFine(aParkingMeter.getFine());
}
...
void ParkingTicket::setFine(double aFine)
{
	fine = aFine;
}
...
void ParkingTicket::reportIllegalCar(ParkedCar aParkedCar, ParkingMeter aParkingMeter, PoliceOfficer aPoliceOfficer)
{
	cout << "\n";
	...
	illegallyParkedHr = ((aParkedCar.getMinutesParked() - aParkingMeter.getMinForParking()) / 60) + 1;
